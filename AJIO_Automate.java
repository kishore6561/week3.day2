...
public class AJIO_Automate {
	public static void main(String[] args) throws InterruptedException {
		...
		java.util.List<WebElement> totalBrands = driver.findElements(By.xpath("//div[@class='brand']"));
		System.out.println("LIST OF BRANDS AVAILABLE: ");
		for (WebElement eachBrand :totalBrands) {
			System.out.println(eachBrand.getText());
		}
		java.util.List<WebElement> overallNames = driver.findElements(By.xpath("//div[@class='name']"));
